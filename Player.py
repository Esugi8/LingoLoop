...
# --- メインエリア ---
if selected_video:
    # (動画読み込み、video_base64, sub_data_js の生成はそのまま)

    # --- 成功時のレイアウトを完全に復元した HTML ---
    html_code = f"""
    <div id="app-wrapper">
        <div id="video-header">
    ...
    <style>
        ...
        .item {{ 
            ...
            user-select: text; /* ここだけ追加：コピー可能にしました */
